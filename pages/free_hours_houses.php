    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            "
            >
              <a class="nav-link" href="https://unkreative.github.io/calendar/pages/all_students.html">students</a>
            </li>
            ...
            justify-content: center;
            font-size: 16px;">
              <a class="nav-link" href="https://unkreative.github.io/calendar/pages/free_hours.php">free hours</a>
            </li>
            ...
            justify-content: center;
            font-size: 16px;">
              <a class="nav-link" href="https://unkreative.github.io/calendar/pages/all_students.html">all students</a>
            </li>


          </ul>
          <form class="form-inline my-2 my-lg-0" action="https://unkreative.github.io/calendar/pages/search.php">
          ...
          <li class="nav-item dropdown" style="list-style:none; color: rgba(0,0,0,.5);">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="scale: 1.2;">
                <a class="dropdown-item" style="color: rgba(0,0,0,.5);" href="https://unkreative.github.io/calendar/pages/settings.php">Settings</a>
                <a class="dropdown-item" style="color: rgba(0,0,0,.5);" href="https://unkreative.github.io/calendar/pages/logout.php">Logout</a>
            </div>  
            </li>
